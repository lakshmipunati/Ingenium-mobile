...
export function BarCodeScanner(props) {
  ...
  const handleBarCodeScanned = ({ type, data }) => {
   // console.log("----handleBarCodeScanned--------", props)
    props.setScanned(false, data, props.activeTab, props.isUdf, props.isVerifyData)
  };
  ...
  if (hasPermission === false) {
    ...
    props.setScanned(false, null, props.activeTab, props.isUdf, props.isVerifyData);
